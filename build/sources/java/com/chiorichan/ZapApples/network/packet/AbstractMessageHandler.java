package com.chiorichan.ZapApples.network.packet;
...
public abstract class AbstractMessageHandler<T extends IMessage> implements IMessageHandler<T, IMessage>
{
	...
	public IMessage onMessage( T message, MessageContext ctx )
	{
		...
		{
			return handleClientMessage( ZapApples.proxy.getPlayerEntity( ctx ), message, ctx );
		}
		else
		{
			return handleServerMessage( ZapApples.proxy.getPlayerEntity( ctx ), message, ctx );
		}
	}
}
