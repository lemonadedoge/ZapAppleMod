  ...
  implements IPacketHandler
{
  public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player)
  {
    ...
    byte id = 0;
    int x = 0; int y = 0; int z = 0; int blockID = 0; int meta = 0;
    try
    {
      ...
      FMLLog.log(Level.SEVERE, e, "Zap Apples cannot read a packet!", new Object[0]);
    }
  ...
  public static void sendDestroyEffectToPlayers(List<uf> players, int x, int y, int z, int blockID, int meta)
  {
    ...
    try
    {
      ...
      FMLLog.log(Level.SEVERE, e, "Zap Apples cannot write a packet!", new Object[0]);
    }
