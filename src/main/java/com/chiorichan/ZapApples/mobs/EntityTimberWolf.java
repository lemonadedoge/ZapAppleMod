...
public class EntityTimberWolf extends EntityTameable
{
  ...
  protected void applyEntityAttributes()
  {
    ...
    getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.300000011920929D);
      ...
      if (itemstack != null)
      {
        ...
        else if (itemstack.itemID == Item.dyePowder.itemID)
        {
          ...
          if (i != getCollarColor())
          {
            ...
            if (!par1EntityPlayer.capabilities.isCreativeMode) if (--itemstack.stackSize <= 0)
              {
                par1EntityPlayer.inventory.setInventorySlotContents(par1EntityPlayer.inventory.currentItem, (ItemStack)null);
              }
