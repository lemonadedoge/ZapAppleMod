...
public class EasyTess
{
  ...
  public static void renderCube(double x, double y, double z, int xDim, int yDim, int zDim, int offsetU, int offsetV, double moveInwards, Icon icon, int flag, int textureWidth, int textureHeight)
  {
    Tessellator tes = Tessellator.instance;
    double minU = icon.getMinU();
    double maxU = icon.getMaxU();
