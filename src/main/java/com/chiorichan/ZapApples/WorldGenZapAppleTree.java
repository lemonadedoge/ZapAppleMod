...
public class WorldGenZapAppleTree extends WorldGenerator
{
  ...
  void generateLeafNode(int par1, int par2, int par3)
  {
    ...
    for (int var5 = par2 + leafDistanceLimit; var4 < var5; var4++)
    {
      ...
      genTreeLayer(par1, var4, par3, var6, (byte)1, ZapApples.zapAppleLeaves.blockID);
    }
  }
  ...
  void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
  {
    ...
    if (var4[var6] != 0)
    {
      ...
      for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
      {
        ...
        setBlockAndMetadata(worldObj, var14[0], var14[1], var14[2], ZapApples.zapAppleLog.blockID, var17);
      }
    }
  }
