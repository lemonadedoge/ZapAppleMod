...
public class WorldGenZapAppleTree extends WorldGenerator{
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger){
        ...
        else
        {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
            {
                ...
                if (var16 != 0 && (var14 != Block.leaves.blockID || var14 != ZapApples.zapAppleLeaves.blockID || var14 == Block.snow.blockID || var14 == Block.vine.blockID))
                {
                    break;
                }
            }
	...
	void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, ZapApples.zapAppleLeaves.blockID);
        }
    }
        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    if (var14 != 0 && (var14 != ZapApples.zapAppleLeaves.blockID || var14 == Block.snow.blockID || var14 == Block.leaves.blockID || var14 == Block.vine.blockID))
                    {
                        ++var13;
                    }
                    else
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        if (var4[var6] != 0)
        {
            ...
            for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
            {
                ...
                this.setBlockAndMetadata(this.worldObj, var14[0], var14[1], var14[2], ZapApples.zapAppleLog.blockID, var17);
            }
        }
    }
		...
		for(int y = basePos[1]; y < basePos[1] + heightLimit + 3; y++){
			for(int x = basePos[0] - leafDistanceLimit - 3; x < basePos[0] + leafDistanceLimit + 3; x++){
				for(int z = basePos[2] - leafDistanceLimit - 3; z < basePos[2] + leafDistanceLimit + 3; z++){
					...
					if(rand.nextInt(8) == 1 && (id == 0 || id == Block.snow.blockID || id == Block.leaves.blockID || id == Block.vine.blockID) && !tile.leafPositions.contains(pos)){
						int side = 0;
						...
						if(side != 0){
							tile.applePositions.put(pos, side);
						}
					}
