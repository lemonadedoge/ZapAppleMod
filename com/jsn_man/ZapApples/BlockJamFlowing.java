...
public class BlockJamFlowing extends BlockFluid implements ILiquid{
    ...
    public BlockJamFlowing(int par1, Material par2Material)
    {
    ...
    public int stillLiquidId(){
    	return ZapApples.jamStill.blockID;
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random){
		Block.waterMoving.randomDisplayTick(par1World, par2, par3, par4, par5Random);
	}
